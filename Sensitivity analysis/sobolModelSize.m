...
function result = sobolModelSize(par)
...
A = [  0     1      0      0         1           1        1;  % EC_tot
       ...
       0     0      0      0   par(18)   par(18)-1        0]; % SC_frac 
...
b2n2c = par(1); b2n4c = par(1)*par(2); b4n2cs = par(1)*par(3);
b4n2cl = par(1)*par(4); b4n4c = par(1)*par(5); b4nSC = par(1)*par(6);
d2n2c = par(7); d2n4c = par(8); d4n2cs = par(9); d4n2cl = par(10);
d4n4c = par(11); d4nSC = par(12); dNP = par(13); pBi = par(14);
pSym = par(15); pCyto = par(16); pOver = par(17); pSC = par(18);
pSCsym = par(19);
...
% commented out for parallel computing
% figure()
...
% y(1)=2n2c; y(2)=2n4c; y(3)=4n2c; y(4)=4n4c; y(5)=4nSC; y(6)=NP
dydt = P*y - sum(P*y)*y;
end
